    ...
    <div class="container">
        <div class="comment-container">
            ...
            <div class="detail-container">
                ...
                <p id="comment-detail">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis</p>
                <div class="interaction-container">
                    ...
                    <div id="reply" role="button" tabindex="0" v-on:click.native="is_clicked = !is_clicked">Reply</div>
                </div>
                <Transition>
                <div class="form-container" v-if="is_clicked">
                    <input class="input-comment" v-model="comment" placeholder="Add an answer..."/>
                    <ButtonItem style="height: 48px" type="primary" state="normal"></ButtonItem>
                </div>
                </Transition>
            </div>
        </div>
...
.comment-info, .interaction-container, .vote {
    display: flex;
    flex-direction: row;
}
